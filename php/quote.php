...
if (trim($shipform) == '') {
    echo '<div class="error_message">Please enter Your Ship from.</div>';
    exit();
}
if (trim($shipto) == '') {
    echo '<div class="error_message">Please enter Your Ship To.</div>';
    exit();
}
if (trim($msg) == '') {
...
$e_sform = "Ship From: $shipform" . PHP_EOL . PHP_EOL;
$e_sto = "Ship To: $shipto" . PHP_EOL . PHP_EOL;
$e_msg = "Message: $msg" . PHP_EOL . PHP_EOL;

$e_reply = "You can contact $name via email, $email ";

$msg = wordwrap($e_body .$e_email. $e_sform . $e_sto . $e_msg . $e_reply, 70);
...
if (mail($address, $e_subject, $msg, $headers)) {
    ...
    echo "<h3>Request Sent Successfully.</h3><br />";
